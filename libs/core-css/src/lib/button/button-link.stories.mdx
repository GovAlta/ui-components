import '../goa-core.css';
import '../goa-components.css';
import { DoDont } from '@goa-dio/storybook-common';
...
<Preview>
  <Story name="Variants" height={100} parameters={
    ...
    <div>
        <button class="goa-button" data-cy="button-primary" type="submit" value="3921">Next step</button>
        <button class="goa-button goa--secondary" data-cy="button-secondary" type="reset" value="3920">Secondary</button>
        <button class="goa-button goa--tertiary" data-cy="button-tertiary" type="reset" value="3920">Tertiary</button>
    </div>
  </Story>
</Preview>
...
<Preview>
  <Story name="Links as Buttons" height={100}>
    <div>
        <a href="#" data-cy="button-link" class="goa-link-button">Call To Action</a>
    </div>
  </Story>
</Preview>
