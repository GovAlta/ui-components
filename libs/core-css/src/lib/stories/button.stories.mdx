...
<Canvas>
  <Story name="Links" height={100}>
    <div>
      <a href="#" data-cy="button-link" class="goa-link-button right-arrow">
        Call To Action
      </a>
    </div>
  </Story>
...
```html
<button class="goa-button" name="buttonSubmit" type="submit" value="3921">
  Next step
</button>
<button
  class="goa-button goa--secondary"
  name="buttonCancel"
  type="reset"
  value="3920"
>
...
a.goa-link-button:focus,
a.goa-link-button:active {
  border-color: #004f84;
  outline: 3px solid #feba35;
  outline-offset: 0;
  background: #004f84;
