...
<Canvas>
  <Story name="Single value preselected">
    {(args, argTypes) => {
      return {
        components: [GoADropdown],
        render: function (createElement) {
...
<Canvas>
  <Story name="Multiselect with preselected values">
    {(args, argTypes) => {
      return {
        components: [GoADropdown],
        render: function (createElement) {
...
<Canvas>
  <Story name="Filter with contains match">
    {(args, argTypes) => {
      return {
        components: [GoADropdown],
        render: function (createElement) {
...
<Canvas>
  <Story name="Filter with starts with match">
    {(args, argTypes) => {
      return {
        components: [GoADropdown],
        render: function (createElement) {
