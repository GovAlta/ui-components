...
import type { GoabCalloutAriaLive, GoabCalloutEmphasis, GoabCalloutIconTheme, GoabCalloutSize, GoabCalloutType, Spacing } from "@abgov/ui-components-common";
...
interface Props {
  ...
  /** Sets the maximum width of the callout.  @default "none" */
  maxWidth?: string;
