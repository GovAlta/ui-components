...
export const SupportInfo = () => {
  return (
    <>
      <h2>Support</h2>
      <GoACallout type="information" title="Need help? Connect with us on Slack">
      ...
      <a href="https://github.com/GovAlta/ui-components/issues/new/choose">Create an issue for a proposed update or contribution</a>
    </>
  )
}
