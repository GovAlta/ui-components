...
<Canvas>
  ...
  >
    {(args) => {
      return {
        template: `<button mat-raised-button color="primary">Primary</button><span style="margin-left:12px"></span>
        <button mat-raised-button color="secondary">Secondary</button><span style="margin-left:12px"></span>
        <button mat-raised-button color="teritary">Teritary</button>`,
      };
    }}
  </Story>
</Canvas>
