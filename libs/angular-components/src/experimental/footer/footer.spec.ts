...
import { GoabxAppFooter } from "../footer/footer";
import { By } from "@angular/platform-browser";

@Component({
  standalone: true,
  imports: [GoabxAppFooter],
  template: ` <goabx-app-footer [maxContentWidth]="maxContentWidth">
...
describe("GoABFooter", () => {
  ...
  beforeEach(fakeAsync(() => {
    TestBed.configureTestingModule({
      imports: [GoabxAppFooter, TestFooterComponent],
