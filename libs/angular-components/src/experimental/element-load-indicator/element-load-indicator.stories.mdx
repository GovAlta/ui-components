...
//libs\angular-components\src\experimental\element-load-indicator\element-load-indicator.stories.mdx
//libs\angular-components\src\lib\button\button.component.ts
import {
  Meta,
  Canvas,
  Story,
...
<Meta
  title="Experimental/Components/ElementLoadIndicator"
