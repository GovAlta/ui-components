...
import { GoabxDropdownItem } from "../dropdown-item/dropdown-item";
...
@Component({
  standalone: true,
  imports: [GoabxDropdown, GoabxDropdownItem],
  ...
  template: `
    <goabx-dropdown
      ...
      (onChange)="onChange()"
    >
      <goabx-dropdown-item [name]="name" label="Red" value="red"></goabx-dropdown-item>
      <goabx-dropdown-item [name]="name" label="Blue" value="blue"></goabx-dropdown-item>
      <goabx-dropdown-item
        [name]="name"
        label="Yellow"
        value="yellow"
