  ...
  <Story name="Basic" height={200}>
    {{
        template: `<span style="width:300px;display:inline-block;">
                    <goa-dropdown (selectionChange)="selectionChanged($event)" [required]="required" [disabled]="disabled" [multiple]="multiple" [label]="label" [description]="description">
                      <goa-option id='apples' [value]='{fruit: "apples"}'>Apples</goa-option>
                      <goa-option id='oranges' [defaultSelected]="true" [value]='{fruit: "oranges"}'><span>Oranges 🍊</span></goa-option>
                      <goa-option id='pears' [value]='{fruit: "pears"}'>Pears</goa-option>
                      <goa-option id='plums' [value]='{fruit: "plums"}'>Plums</goa-option>
                      <goa-option id='peaches' [value]='{fruit: "peaches"}'>Peaches</goa-option>
                      <goa-option id='watermelons' [value]='{fruit: "watermelons"}'>Watermelon</goa-option>
                      <goa-option id='tomatoes' [value]='{fruit: "tomatoes"}'>Tomatoes</goa-option>
                      <goa-option id='papayas' [value]='{fruit: "papayas"}'>Papayas</goa-option>
                      <goa-option id='bananas' [value]='{fruit: "bananas"}'>Bananas</goa-option>
                      <goa-option id='pineapples' [value]='{fruit: "pineapples"}'>Pineapples</goa-option>
                    </goa-dropdown>
                  </span>`,
        props: {
...
<goa-dropdown (selectionChange)="selectionChanged($event)" label="Fruits" description="Select your favourite fruit.">
  <goa-option id='apples' [value]='{fruit: "apples"}'>Apples</goa-option>
  <goa-option id='oranges' [value]='{fruit: "oranges"}'><span>We can put icons or other markup</span></goa-option>
  <goa-option id='pears' [value]='{fruit: "pears"}'>Pears</goa-option>
</goa-dropdown>
```
