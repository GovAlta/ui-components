...
export class GoabWorkSideMenu implements OnInit {
  ...
  @Input() testId?: string;
  /** @required Template reference for the primary navigation slot content. */
  @Input() primaryContent!: TemplateRef<any>;
  /** @required Template reference for the secondary navigation slot content. */
  @Input() secondaryContent!: TemplateRef<any>;
  /** @required Template reference for the account slot content. */
