...
describe("GoABCalendar", () => {
  ...
  it("should render properties", () => {
    ...
    expect(calendar.getAttribute("value")).toBe(component.value?.toString());
  ...
  it("should handle the event", () => {
    ...
    fireEvent(calendar, new CustomEvent("_change", { detail: { type: "date", value: new Date(), name: component.name } }));
