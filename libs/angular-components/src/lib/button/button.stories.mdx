...
<Meta title="Design System/Basic Elements/Buttons/Angular" decorators={[
        withKnobs,
...
Set buttonStyle='primary', buttonStyle='secondary', buttonStyle='tertiary' to change the style.
...
<Preview>
  <Story name="Variants" height={100} parameters={
    ...
    {{
        template: `<goa-button [title]='title' (onClick)='onClick($event)' [buttonType]=buttonType></goa-button>`,
        //template: `<goa-button title='test' buttonType='Secondary'></goa-button>`,
        props: {
