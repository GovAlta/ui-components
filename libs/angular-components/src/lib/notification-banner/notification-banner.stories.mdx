...
<Meta title="Component Library/Components/Notifications"
  ...
  decorators={[
        moduleMetadata({ declarations: [GoANotificationComponent, GoANotificationBannerComponent] }),
    ]
} />
...
<goa-notification-banner title="Notifications">
  <goa-notification type="information" message="Integer et lacus vitae ante faucibus fringilla in in lacus." notificationUrl="/infoPage"></goa-notification>
</goa-notification-banner>
```
