...
describe("Accordion", () => {
  it("should render successfully", () => {
    const { baseElement } = render(<GoAAccordion heading="The heading">Accordion Content</GoAAccordion>);
  ...
  it('should set the props correctly', () => {
    const { baseElement } = render(
      <GoAAccordion heading="The heading"
        secondaryText="Secondary Text"
        open={true}
        headingContent= {<GoABadge type="success" content="test-badge"></GoABadge>}
      >Accordion Content</GoAAccordion>
    );
    const el = baseElement.querySelector("goa-accordion");
