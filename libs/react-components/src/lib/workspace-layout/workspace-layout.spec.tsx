...
describe("WorkspaceLayout", () => {
  ...
  it("renders pushDrawer into the push-drawer slot", () => {
    const { container } = render(
      <GoabWorkspaceLayout pushDrawer={<span>Drawer</span>}>Body</GoabWorkspaceLayout>,
    );
    const el = container.querySelector("goa-workspace-layout");
    const slot = el?.querySelector("[slot='push-drawer']");
    expect(slot?.textContent).toContain("Drawer");
  });
