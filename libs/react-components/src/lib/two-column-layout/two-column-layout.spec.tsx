...
describe('TwoColumnLayout', () => {
  it('should render successfully', () => {
    const { baseElement } = render(<TwoColumnLayout
      header={<GoAAppHeader />}
      footer={<GoAAppFooter />}
      nav={<Links />}
    >
    ...
    expect(baseElement.innerHTML).toContain("Lorem ipsum dolor sit amet, qui minim labore adipisicing minim sint cillum sint consectetur cupidatat.")
