...
describe('Notification Banner', () => {
  ...
  describe("type", () => {
  ['important', 'information', 'emergency', 'event'].forEach((type: NotificationType) => {
    it(`should render ${type} notification`, async function () {
      render(<GoANotification type={type}>Information to the user goes in the content</GoANotification>);
