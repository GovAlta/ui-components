...
import GoabxTextArea from "./textarea";
...
describe("GoabxTextArea", () => {
  it("should render with properties", async () => {
    render(<GoabxTextArea name="textarea-name" onChange={noop} />);
  ...
  it("should pass data-grid attributes", () => {
    render(<GoabxTextArea name="textarea-name" onChange={noop} data-grid="cell" />);
    const el = document.querySelector("goa-textarea");
