...
describe("GoabxBadge", () => {
  it("should render with default behavior (no icon)", () => {
    const { container } = render(
      <GoabxBadge type="information" content="Text Content" />,
    );
  ...
  it("should pass data-grid attributes", () => {
    const { container } = render(
      <GoabxBadge type="information" content="Text Content" data-grid="cell" />,
    );
    const el = container.querySelector("goa-badge");
  ...
  it("should render custom icon type when icontype is provided", () => {
    const { container } = render(
      <GoabxBadge type="information" content="Custom Icon" iconType="home" />,
    );
    const el = container.querySelector("goa-badge");
  ...
  it("should not render icontype when not provided", () => {
    const { container } = render(
      <GoabxBadge type="success" content="Default Icon" icon />,
    );
    const el = container.querySelector("goa-badge");
  ...
  it("should pass icon=false correctly to web component", () => {
    const { container } = render(
      <GoabxBadge type="success" content="No Icon" icon={false} iconType="star" />,
    );
    const el = container.querySelector("goa-badge");
  ...
  it("should pass icon='true' when icon={true} explicitly", () => {
    const { container } = render(
      <GoabxBadge type="information" content="Show Icon" icon={true} />,
    );
    const el = container.querySelector("goa-badge");
  ...
  it("should pass icon='false' when icon={false} without iconType", () => {
    const { container } = render(
      <GoabxBadge type="success" content="No Icon" icon={false} />,
    );
    const el = container.querySelector("goa-badge");
  ...
  it("should pass icon='false' when icon={undefined}", () => {
    const { container } = render(
      <GoabxBadge type="important" content="Undefined Icon" icon={undefined} />,
    );
    const el = container.querySelector("goa-badge");
  ...
  it("should pass icon='true' when iconType and icon={true} both provided", () => {
    const { container } = render(
      <GoabxBadge type="success" content="Custom Star" icon={true} iconType="star" />,
    );
    const el = container.querySelector("goa-badge");
