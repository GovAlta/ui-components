...
<DoDont
  dos={'Add any action buttons into a GoAModalActions component at the bottom of the modal'}
  donts={'Provide both action buttons and on `onClose` event handler, as this will result in a `x` icon in the top corner'}
/>
