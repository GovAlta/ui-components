...
import GoabxCheckbox, { Props as CheckboxProps } from "./checkbox";
...
describe("GoabxCheckbox", () => {
  ...
  it("should render with boolean value", () => {
    render(<GoabxCheckbox name="foo" value={true} />);
  ...
  it("should render with text description", () => {
    render(
      <GoabxCheckbox name={"foo"} checked={false} description={"description text"} />,
    );
  ...
  it("should render with slot description", () => {
    const result = render(
      <GoabxCheckbox name={"foo"} description={<div>description slot</div>} />,
    );
  ...
  it("should render with slot reveal", () => {
    const result = render(<GoabxCheckbox name={"foo"} reveal={<div>reveal slot</div>} />);
  ...
  it("should pass data-grid attributes", () => {
    render(<GoabxCheckbox name="test" data-grid="cell" />);
    const checkbox = document.querySelector("goa-checkbox");
