        ...
        <div class="v2-logo-area">
          {#if url}
            <a href={url} data-testid="v2-logo-link">
              <img alt="GoA Logo" class="v2-logo-mobile" src={_isDarkMode ? _v2MobileLogoDark : _v2MobileLogo} />
              <img alt="GoA Logo" class="v2-logo-desktop" src={_isDarkMode ? _v2DesktopLogoDark : _v2DesktopLogo} />
            </a>
          {:else}
            <img alt="GoA Logo" class="v2-logo-mobile" src={_isDarkMode ? _v2MobileLogoDark : _v2MobileLogo} />
            <img alt="GoA Logo" class="v2-logo-desktop" src={_isDarkMode ? _v2DesktopLogoDark : _v2DesktopLogo} />
