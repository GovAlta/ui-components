...
<style>
  ...
  --goa-container-border-radius: var(--goa-border-radius-m); /* 4px */
  --goa-container-relaxed-padding: var(--goa-space-xl); /* 32px */
  --goa-container-compact-padding: var(--goa-space-m); /* 16px */
  --goa-container-heading: var(--goa-typography-heading-s);
  --goa-container-heading-padding: var(--goa-space-xs); /* 8px */
  --goa-container-heading-gap: var(--goa-space-l); /* 24px */
  ...
  .padding--relaxed header {
    padding: 0 var(--goa-container-relaxed-padding);
  }
  .padding--relaxed .content {
    padding: var(--goa-container-relaxed-padding);
  }

  .padding--compact header,
  .padding--compact .content {
    padding: 0 var(--goa-container-compact-padding);
  }
  .padding--compact header {
    padding: 0 var(--goa-container-compact-padding);
  }
  .padding--compact .content {
    padding: var(--goa-container-compact-padding);
  }
