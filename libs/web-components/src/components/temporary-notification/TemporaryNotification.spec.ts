...
describe("GoATemporaryNotification", () => {
  ...
  describe("action button", () => {
    ...
    it("should log warning when actionText is provided for non-basic notification", async () => {
      const consoleSpy = vi.spyOn(console, "warn").mockImplementation(() => {});

      render(GoATemporaryNotification, {
        testid: "notification-test",
        message: "Test notification",
        type: "success",
        actionText: "Undo"
      ...
      await waitFor(() => {
        expect(consoleSpy).toHaveBeenCalledWith("Actions are only supported for basic notifications");
      });
