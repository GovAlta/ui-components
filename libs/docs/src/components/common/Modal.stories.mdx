  ...
  <Tab label="Angular">
    <CodeSnippet
      ...
      code={`
        ...
        <goa-modal id="modal" [open]="isOpen" (_close)="closeModal()" closable>
          <p>
            Lorem ipsum dolor sit amet consectetur adipisicing elit. Mollitia obcaecati id molestiae,
            natus dicta, eaque qui iusto similique, libero explicabo eligendi eius laboriosam!
            Repellendus ducimus officia asperiores. Eos, eius numquam.
...
<Tabs>
  ...
  <Tab label="Angular">
    <CodeSnippet
      ...
      <goa-modal id="modal" [open]="isOpen" (_close)="closeModal()" closable [transition]="transition">
        <p>
          Lorem ipsum dolor sit amet consectetur adipisicing elit. Mollitia obcaecati id molestiae,
          natus dicta, eaque qui iusto similique, libero explicabo eligendi eius laboriosam!
          Repellendus ducimus officia asperiores. Eos, eius numquam.
...
<Tabs>
  <Tab label="Web Component" hidden={true}>
    <CodeSnippet
      ...
      <goa-modal id="modal" type="callout" calloutVariant={calloutVariant}>
        <p>
          Lorem ipsum dolor sit amet consectetur adipisicing elit. Mollitia obcaecati id molestiae,
          natus dicta, eaque qui iusto similique, libero explicabo eligendi eius laboriosam!
          Repellendus ducimus officia asperiores. Eos, eius numquam.</p>
  ...
  <Tab label="Angular">
    <CodeSnippet
      ...
      <goa-modal id="modal" type="callout" [open]="isOpen" [calloutVariant]="calloutVariant">
        <p>
          Lorem ipsum dolor sit amet consectetur adipisicing elit. Mollitia obcaecati id molestiae,
          natus dicta, eaque qui iusto similique, libero explicabo eligendi eius laboriosam!
          Repellendus ducimus officia asperiores. Eos, eius numquam.
