...
<Props>
  ...
  <Prop name="handletrailingiconclick" type="boolean" defaultValue="false" description="Only required for Angular and web-component usage"/>
  ...
  <Prop name="showcounter" type="boolean" defaultValue="false" description="Shows the number of characters entered if it is set to True"/>
<Prop name="maxcharcount" type="number" description="Maximum number of characters allowed in the input box"/>
<Prop
  name="min"
  type="string | date"
...
/>
  ...
  />
  <Prop name="_trailingiconclick" type="CustomEvent" description="onclick function invoked when trailing icon is clicked"/>
</Props>
