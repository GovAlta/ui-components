...
<Props>
  ...
  <Prop
    ...
    type="boolean"
    defaultValue="false"
    description="Only required for Angular and web-component usage"
  />
  ...
  <Prop
    name="prefix"
    type="string"
    description="The text that comes before the input"
  />
  <Prop
    name="suffix"
    type="string"
    description="The text that comes after the input"
  />
  <Prop
    name="_change"
