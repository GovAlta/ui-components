...
<Props showTabs={true}>
  ...
  />
  <Prop name="leadingicon" lang="angular" type="GoAIconType" description="Icon shown to the left of the text"/>
  <Prop name="trailingicon" lang="angular" type="GoAIconType" description="Icon shown to the right of the text" />

  <Prop name="leadingIcon" lang="react" type="GoAIconType" description="Icon shown to the left of the text"/>
  <Prop name="trailingIcon" lang="react" type="GoAIconType" description="Icon shown to the right of the text" />

  <Prop name="disabled" type="boolean" defaultValue="false" description="Disable this control. It will not receive focus or events"/>
  <Prop name="handletrailingiconclick" lang="angular" type="boolean" defaultValue="false" description="Only required for Angular and web-component usage"/>
...
/>
  ...
  <Prop
    ...
    description="Callback function invoked when input value is changed"
  />
  <Prop name="onTrailingIconClick" lang="react" type="CustomEvent" description="onclick function invoked when trailing icon is clicked"/>
...
export const DateTimeExample = () => {
  const [date, setDate] = useState(new Date());
  return <GoAInputDateTime name="dateTimeExample" value={date} />;
};
