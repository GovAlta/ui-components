...
<Props>
  <Prop
    name="type"
    type="text | number | password | email | search | tel | time | url | week"
    defaultValue="text"
  />
  ...
  <Prop name="handletrailingiconclick" type="boolean" />
  <Prop name="focused" type="boolean" />
  <Prop name="readonly" type="boolean" />
  <Prop name="error" type="boolean" />
  <Prop name="width" type="string" defaultValue="30ch" />
  <Prop name="showcounter" type="boolean" />
