...
<Story name="Information">
  <GoACallout type="information">
    Use the Form Item as a wrapper for the Input component to add more features such as label, help and error texts etc.
  </GoACallout>
</Story>
...
<Tabs>
  ...
  <Tab label="Angular">
    <CodeSnippet
      lang="html"
      code={`
      <goa-input goaValue [(ngModel)]="firstName"></goa-input>
    `}
    />
    <CodeSnippet
      lang="ts"
...
export const FocusInputTemplate = () => {
  ...
  return <>
    <GoAInput name="foo" focused={focused} value="Some value" onChange={noop} />
    <br />
