...
import { Tabs, Tab, CodeSnippet, SupportInfo, Props, Prop } from '@abgov/shared/storybook-common';
...
[Figma design component](https://www.figma.com/file/3pb2IK8s2QUqWieH79KdN7/%E2%9D%96-Components-%7C-DDI-DS?node-id=3799%3A118526)
...
export const ProgressTemplate = (args) => {
  ...
  return <GoACircularProgress {...args} progress={progress} type="progress" variant="inline" visible={true} size="large" />
};
...
export const FullscreenTemplate = (args) => {
  ...
  return (
    <>
      ...
      <GoACircularProgress {...args} visible={visible} variant="fullscreen" size="large" />
    </>
  )
};
...
export const FullscreenProgressTemplate = () => {
  ...
  return (
    <>
      ...
      <GoACircularProgress visible={visible} variant="fullscreen" progress={progress} type="progress" size="large" />
    </>
  )
};
...
<Props>
  <Prop name="type" type="infinite | progress" required={true} description="The type of progress indicator" />
  <Prop name="variant" type="fullscreen | inline" required={true} description="The variant of progress indicator" />
  <Prop name="visible" type="boolean" required={true} description="Shows/hides the page loader, allowing for fade transition to be applied in each transition." />
  <Prop name="size" type="small | large" required={true} description="The size of progress indicator" />
  <Prop name="progress" type="number" defaultValue="0" description="The progress value" />
  <Prop name="message" type="object" defaultValue="" description="Text displayed under the circular spinner" />
</Props>

#### Sizes

<Story name="Sizes">
  <GoACircularProgress type="infinite" variant="inline" visible={true} message="Loading..." size="small" />
  <GoACircularProgress type="infinite" variant="inline" visible={true} message="Loading..." size="large" />
</Story>
...
<Story name="Inline infinite">
  <GoACircularProgress type="infinite" variant="inline" visible={true} size="large" />
</Story>
