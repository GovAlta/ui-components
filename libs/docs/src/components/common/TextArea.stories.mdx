...
<Props showTabs={true}>
  ...
  />
  <Prop name="maxcharcount" lang="angular" type="number" description="Set the max character count" />
  ...
  <Prop
    ...
    description="Show/hide the character counter"
  />
  <Prop name="maxCharCount" lang="react" type="number" description="Set the max character count" />
