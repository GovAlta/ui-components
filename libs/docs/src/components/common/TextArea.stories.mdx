...
<Note type="caution">
  Use labels and helper text to communicate how a field should be filled out.
</Note>
...
<Note type="best-practices">
  <ul>
    <li>
      Make empty TextAreas as tall as the content they are expected to contain.
    </li>
    <li>
      Don't use a TextArea which is only one line high.
    </li>
  </ul>
</Note>
