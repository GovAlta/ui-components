...
<Props>
  ...
  />
  <Prop name="error" type="boolean" defaultValue="false" description="if we show an error or not" />
  <Prop name="disabled" type="boolean" defaultValue="false" description="if the component is disabled or not" />
</Props>
