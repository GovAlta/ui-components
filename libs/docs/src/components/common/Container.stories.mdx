...
<Props showTabs={true}>
  ...
  <Prop
    ...
    lang="angular"
    defaultValue=""
    description="Sets the content in the left of the accent bar. To only be used along with accent=thick."
  />
  <Prop
    name="heading"
    type="ReactNode"
  ...
  <Prop
    ...
    lang="angular"
    defaultValue=""
    description="Sets the content in the right of the accent bar. To only be used along with accent=thick."
  />
  <Prop
    name="actions"
    type="ReactNode"
