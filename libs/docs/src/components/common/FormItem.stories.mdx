...
<Props>
  ...
  <Prop
    name="helptext"
    type="string"
    description="Text displayed under the form field providing an addition explanation"
  />
  <Prop
    name="error"
    type="string"
    description="The error message for the form field. Leave blank to indicate valid field."
  />
  <Prop
    name="optional"
    type="boolean"
    defaultValue="false"
    description="Flag to show/hide the indicator to whether the field is optional"
  />
</Props>
