...
<Story name="Label Size">
  ...
  <div style={{ padding: "8px" }}></div>
  <GoAFormItem label="Checkbox Colors" labelSize="large">
    <GoACheckbox name="colors" text="Red" value="red"></GoACheckbox>
    <GoACheckbox name="colors" text="Blue" value="blue"></GoACheckbox>
  </GoAFormItem>
  <div style={{ padding: "8px" }}></div>
  ...
  <div style={{ padding: "8px" }}></div>
  <GoAFormItem label="Button label" labelSize="large">
    <GoAButtonGroup alignment="start">
      <GoAButton type="primary">Next</GoAButton>
    </GoAButtonGroup>
  </GoAFormItem>
...
<Tabs>
  <Tab label="Angular">
    <CodeSnippet
      lang="html"
      code={`
      <goa-form-item label="First name" id="firstName" labelsize="large" requirement="required">
        <goa-input name="firstName" arialabelledby="firstName"></goa-input>
      </goa-form-item>
      <goa-form-item label="Checkbox Colors" labelsize="large">
        <goa-checkbox name="colors" text="Red" value="red"></goa-checkbox>
        <goa-checkbox name="colors" text="Blue" value="blue"></goa-checkbox>
      </goa-form-item>
      <goa-form-item label="Radio Colors">
      ...
      <goa-form-item label="Button label" labelsize="large">
          <goa-button type="primary">Next</goa-button>
      </goa-form-item>
    `}
    />
  ...
  <Tab label="React">
    <CodeSnippet
      lang="tsx"
      code={`
          <GoAFormItem label="First name" id="firstName" labelSize="large" requirement="required">
            <GoAInput name="firstName" ariaLabelledBy="firstName" value="" onChange={() => void 0}/>
          </GoAFormItem>
          <GoAFormItem label="Checkbox Colors" labelSize="large">
            <GoACheckbox name="colors" text="Red" value="red" checked={false}></GoACheckbox>
