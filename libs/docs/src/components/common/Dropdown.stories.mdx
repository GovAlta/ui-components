...
export const Template = (args) => {
  ...
  return (
    <GoADropdown {...args} value={value} onChange={onChange}>
      <GoADropdownOption value="red" label="Red" />
      <GoADropdownOption value="green" label="Green" />
      <GoADropdownOption value="blue" label="Blue" />
    </GoADropdown>
  );
};
...
<Story name="Native">
  <GoADropdown
    ...
    native={true}
  >
    <GoADropdownOption name="native" value="red" label="Red" />
    <GoADropdownOption name="native" value="green" label="Green" />
    <GoADropdownOption name="native" value="blue" label="Blue" />
  </GoADropdown>
</Story>
