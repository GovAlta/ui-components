...
<Tabs>
  <Tab label="Web Component">
    <pre>
      { `<goa-checkbox text="World Peace" value="life" checked></goa-checkbox>` }
    </pre>
    <pre>
      { `<goa-checkbox text="War" value="hell" disabled></goa-checkbox>` }
    </pre>
    <pre>
      { `<goa-checkbox text="Winter Picnic" value="fun" indeterminate></goa-checkbox>` }
    </pre>
    <pre>
      { `<goa-checkbox text="Drink and Drive" value="irresponsible and dangerous" error></goa-checkbox>` }
    </pre>
  </Tab>
  <Tab label="Angular">
    <pre>
  ...
  <Tab label="React">
    <pre>
      { `<GoACheckbox text="World Peace" value="life" checked></GoACheckbox>` }
    </pre>
    <pre>
      { `<GoACheckbox text="War" value="hell" disabled></GoACheckbox>` }
    </pre>
    <pre>
      { `<GoACheckbox text="Winter Picnic" value="fun" indeterminate></GoACheckbox>` }
    </pre>
    <pre>
      { `<GoACheckbox text="Drink and Drive" value="irresponsible and dangerous" error></GoACheckbox>` }
    </pre>
  </Tab>
</Tabs>
