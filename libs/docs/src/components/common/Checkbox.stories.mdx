...
<Tabs>
  <Tab label="Web Component">
    <CodeSnippet code={`<goa-checkbox text="World Peace" value="life" checked></goa-checkbox>`} lang="html" />
    <CodeSnippet code={`<goa-checkbox text="War" value="hell" disabled></goa-checkbox>`} lang="html" />
    <CodeSnippet code={`<goa-checkbox text="Winter Picnic" value="fun" indeterminate></goa-checkbox>`} lang="html" />
    <CodeSnippet code={`<goa-checkbox text="Drink and Drive" value="irresponsible and dangerous" error></goa-checkbox>`} lang="html" />
  </Tab>
  <Tab label="Angular">
    <CodeSnippet code={`<goa-checkbox text="World Peace" value="life" checked></goa-checkbox>`} lang="html" />
    <CodeSnippet code={`<goa-checkbox text="War" value="hell" disabled></goa-checkbox>`} lang="html" />
  ...
  <Tab label="React">
    <CodeSnippet code={`<GoACheckbox text="World Peace" value="life" checked></GoACheckbox>`} lang="jsx" />
    <CodeSnippet code={`<GoACheckbox text="War" value="hell" disabled></GoACheckbox>`} lang="jsx" />
    <CodeSnippet code={`<GoACheckbox text="Winter Picnic" value="fun" indeterminate></GoACheckbox>`} lang="jsx" />
    <CodeSnippet code={`<GoACheckbox text="Drink and Drive" value="irresponsible and dangerous" error></GoACheckbox>`} lang="jsx" />
  </Tab>
</Tabs>
