...
<Props>
  <Prop
    name="type"
    type="success | warning | information | emergency | inactive | dark | midtone | light"
    required={true}
  ...
  <Tab label="Angular">
    <CodeSnippet
      ...
      code={`
        ...
        <goa-badge type="warning" content="Warning"></goa-badge>
  ...
  <Tab label="Angular">
    <CodeSnippet
      ...
      code={`
        ...
        <goa-badge type="warning" icon></goa-badge>
  ...
  <Tab label="Angular">
    <CodeSnippet
      ...
      code={`
        ...
        <goa-badge type="warning" content="Warning" icon="true"></goa-badge>
