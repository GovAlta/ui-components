...
[Figma](https://www.figma.com/file/qWGWDvULAAZuVaDpXCRzqP/DS-Website?node-id=820%3A11807)
...
<goa-badge type="inactive" content="Inactive" />
...
<goa-callout type="information" title="Need help? Connect with us on Slack">
  #design-system-support General information and discussion related to design system including questions, new component proposals, contribution, and other requests.
</goa-callout>
