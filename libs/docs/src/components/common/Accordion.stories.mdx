...
<GoACallout>
  Accordion containers enable multiple content sections to be displayed in a
  limited space and collapsed or expanded by the user. You can create hierarchy
  of information by hiding secondary content inside collapsed expand containers.
</GoACallout>
...
<GoACallout>
  The open prop on accordion component can be used to control a group of
  accordions.
</GoACallout>
