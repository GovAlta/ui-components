...
<Story name="Max Content Width">
  <GoAMicrositeHeader type="live" maxContentWidth="600px" />
  <GoAAppHeader
...
<Tabs>
  <Tab label="Web Component" hidden={true}>
    <CodeSnippet
      lang="html"
      code={`
      <goa-microsite-header type="live" maxcontentwidth="600px"/>
  ...
  <Tab label="Angular">
    <CodeSnippet
      lang="html"
      code={`
      <goa-microsite-header type="live" maxContentWidth="600px"></goa-microsite-header>
      <goa-app-header url="https://example.com" heading="Ticket and Find Payments" maxContentWidth="600px">
        <a href="#">Login</a> &nbsp;
        <a href="#">Help</a>
      </goa-app-header>
