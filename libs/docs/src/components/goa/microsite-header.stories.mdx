...
<Tabs>
  <Tab label="Web Component" hidden={true}>
    <CodeSnippet
      lang="html"
      code={`
      <goa-microsite-header type="alpha" version="v1.2.3" feedbackurl="https://example.com/feedback" maxcontentwidth="600px"/>
    `}
    />
  </Tab>
  <Tab label="Angular">
    <CodeSnippet
      lang="html"
      code={`
      <goa-microsite-header type="alpha" version="v1.2.3" feedbackUrl="https://example.com/feedback" maxContentWidth="600px"></goa-microsite-header>
    `}
    />
  </Tab>
  <Tab label="React">
    <CodeSnippet
      lang="jsx"
      code={`
      <GoAMicrositeHeader type="alpha" version="v1.2.3" feedbackUrl="https://example.com/feedback" maxContentWidth="600px"/>
    `}
    />
  </Tab>
</Tabs>
