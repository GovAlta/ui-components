  ...
  configurations: [
    {
      ...
      code: {
        ...
        angular: `<goab-filter-chip content="Active" (onClick)="handleToggle()"></goab-filter-chip>`,
    ...
    },
    {
      ...
      code: {
        react: `<GoabFilterChip content="All" onClick={() => setFilter('all')} />
...
<GoabFilterChip content="Completed" onClick={() => setFilter('completed')} />`,
        angular: `<goab-filter-chip content="All" (onClick)="setFilter('all')"></goab-filter-chip>
...
<goa-filter-chip version="2" content="Completed"></goa-filter-chip>`,
    ...
    },
    {
      ...
      code: {
        react: `<GoabFilterChip content="Edmonton" secondaryText="City:" onClick={handleToggle} />
<GoabFilterChip content="Calgary" secondaryText="City:" onClick={handleToggle} />`,
        angular: `<goab-filter-chip content="Edmonton" secondaryText="City:" (onClick)="handleToggle()"></goab-filter-chip>
...
<goa-filter-chip version="2" content="Calgary" secondarytext="City:"></goa-filter-chip>`,
    ...
    },
    {
      ...
      code: {
        react: `<GoabFilterChip content="Documents" leadingIcon="document" onClick={handleToggle} />
<GoabFilterChip content="Sort" leadingIcon="arrow-up" onClick={handleToggle} />`,
        angular: `<goab-filter-chip content="Documents" leadingIcon="document" (onClick)="handleToggle()"></goab-filter-chip>
