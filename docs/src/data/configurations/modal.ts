...
const reactModalSetup = `const [isOpen, setIsOpen] = useState<boolean>(false);

const handleClose = () => {
  setIsOpen(false);
};`;

const angularModalSetup = `export class SomeOtherComponent {
  isOpen = false;
...
const reactModalSetupWithConfirm = `const [isOpen, setIsOpen] = useState<boolean>(false);
...
const angularModalSetupWithConfirm = `export class SomeOtherComponent {
  isOpen = false;
...
const reactModalSetupWithDelete = `const [isOpen, setIsOpen] = useState<boolean>(false);
...
const angularModalSetupWithDelete = `export class SomeOtherComponent {
  isOpen = false;
...
const reactModalSetupWithExtend = `const [isOpen, setIsOpen] = useState<boolean>(false);

const handleExtend = () => {
  // Extend the session, then close
  setIsOpen(false);
};`;

const angularModalSetupWithExtend = `export class SomeOtherComponent {
  isOpen = false;
...
export const modalConfigurations: ComponentConfigurations = {
  ...
  configurations: [
    {
      ...
      code: {
        react: {
          ts: reactModalSetupWithConfirm,
          jsx: `<GoabModal heading="Confirm action" open={isOpen}>
  ...
  <GoabButtonGroup alignment="end" mt="l">
    ...
    <GoabButton size="compact" onClick={handleConfirm}>Confirm</GoabButton>
        ...
        angular: {
          ts: angularModalSetupWithConfirm,
          template: `<goab-modal heading="Confirm action" [open]="isOpen">
  <p>Are you sure you want to proceed with this action?</p>
...
<goa-modal id="demo-modal" heading="Confirm action">
  <p>Are you sure you want to proceed with this action?</p>
...
<script>${modalScript}</script>`,
    ...
    },
    {
      ...
      code: {
        react: {
          ts: reactModalSetup,
          jsx: `<GoabModal heading="Information" open={isOpen} onClose={handleClose}>
  ...
  <p>You can close this modal with the X button or by clicking the backdrop.</p>
        ...
        webComponents: `<goa-button id="open-modal">Open modal</goa-button>
<goa-modal id="demo-modal" heading="Information" closable>
  <p>You can close this modal with the X button or by clicking the backdrop.</p>
</goa-modal>
<script>${modalScript}</script>`,
      },
    },
    {
      ...
      code: {
        react: {
          ts: reactModalSetupWithDelete,
          jsx: `<GoabModal heading="Are you sure you want to delete this item?" open={isOpen} calloutVariant="emergency">
  ...
  <GoabButtonGroup alignment="end" mt="l">
    ...
    <GoabButton variant="destructive" size="compact" onClick={handleDelete}>Delete</GoabButton>
        ...
        angular: {
          ts: angularModalSetupWithDelete,
          template: `<goab-modal heading="Are you sure you want to delete this item?" [open]="isOpen" calloutVariant="emergency">
  <p>This action cannot be undone. The item will be permanently removed.</p>
  <goab-button-group alignment="end" mt="l">
    <goab-button type="secondary" size="compact" (onClick)="handleClose()">Cancel</goab-button>
    <goab-button variant="destructive" size="compact" (onClick)="handleDelete()">Delete</goab-button>
        ...
        webComponents: `<goa-button id="open-modal">Open modal</goa-button>
<goa-modal id="demo-modal" heading="Are you sure you want to delete this item?" calloutvariant="emergency">
  <p>This action cannot be undone. The item will be permanently removed.</p>
  <goa-button-group alignment="end" mt="l">
    <goa-button type="secondary" size="compact">Cancel</goa-button>
...
<script>${modalScript}</script>`,
    ...
    },
    {
      ...
      code: {
        react: {
          ts: reactModalSetupWithExtend,
          jsx: `<GoabModal heading="Your session is about to expire" open={isOpen} calloutVariant="important">
  ...
  <GoabButtonGroup alignment="end" mt="l">
    <GoabButton size="compact" onClick={handleExtend}>Stay logged in</GoabButton>
        ...
        angular: {
          ts: angularModalSetupWithExtend,
          template: `<goab-modal heading="Your session is about to expire" [open]="isOpen" calloutVariant="important">
  <p>You will be logged out in 5 minutes due to inactivity.</p>
  <goab-button-group alignment="end" mt="l">
    <goab-button size="compact" (onClick)="handleExtend()">Stay logged in</goab-button>
        ...
        webComponents: `<goa-button id="open-modal">Open modal</goa-button>
<goa-modal id="demo-modal" heading="Your session is about to expire" calloutvariant="important">
  <p>You will be logged out in 5 minutes due to inactivity.</p>
  <goa-button-group alignment="end" mt="l">
...
<script>${modalScript}</script>`,
    ...
    },
    {
      ...
      code: {
        react: {
          ts: reactModalSetup,
          jsx: `<GoabModal heading="New features available" open={isOpen} calloutVariant="information" onClose={handleClose}>
  ...
  <p>We have updated the application with new features. Review the changes to get started.</p>
        ...
        webComponents: `<goa-button id="open-modal">Open modal</goa-button>
<goa-modal id="demo-modal" heading="New features available" closable calloutvariant="information">
  <p>We have updated the application with new features. Review the changes to get started.</p>
</goa-modal>
<script>${modalScript}</script>`,
      },
    },
    {
      ...
      code: {
        react: {
          ts: reactModalSetup,
          jsx: `<GoabModal heading="Application submitted" open={isOpen} calloutVariant="success" onClose={handleClose}>
  ...
  <p>Your application has been successfully submitted. You will receive a confirmation email shortly.</p>
        ...
        webComponents: `<goa-button id="open-modal">Open modal</goa-button>
<goa-modal id="demo-modal" heading="Application submitted" closable calloutvariant="success">
  <p>Your application has been successfully submitted. You will receive a confirmation email shortly.</p>
</goa-modal>
<script>${modalScript}</script>`,
      },
    },
    {
      ...
      code: {
        react: {
          ts: reactModalSetup,
          jsx: `<GoabModal heading="Wide modal" open={isOpen} maxWidth="80ch" onClose={handleClose}>
