 ...
 * - ComponentsSubMenu: Submenu for browsing components by category
 * - GetStartedSubMenu: Submenu for Get Started pages (designers, developers, etc.)
 *
...
export type { GetStartedNav } from "../../lib/get-started-nav";
export { FoundationsSubMenu } from "./FoundationsSubMenu";
