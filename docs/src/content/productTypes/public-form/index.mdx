...
<goa-button type="tertiary" mt="s" mb="l" onclick="window.open('https://govalta.github.io/goa-public-form-playground/', '_blank')">View demo</goa-button>

import PreviewContainer from "../../../components/PreviewContainer.astro";

<goa-callout type="information" emphasis="low" maxwidth="480px"><strong>Primary user:</strong> Citizens applying for a service, benefit, permit, or status update.</goa-callout>
...
Asking a question does not necessarily mean you should use one form field. Asking a user for their address is best captured all on the same page with multiple fields. See the <a href={withBase("/examples/question-page#group-related-questions-on-one-page")}>grouped fields variant on the question page</a>.
...
- adding simple <a href={withBase("/examples/question-page#show-a-progress-indicator")}>progress indicators on a question page</a> to communicate progress
- breaking the form into sections on a <a href={withBase("/examples/task-list-page")}>task list page</a>
