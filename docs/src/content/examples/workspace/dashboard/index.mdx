...
previewUrl: https://govalta.github.io/goa-workspace-playground/
...
The layout uses <a href={withBase("/components/container")}>containers</a> and <a href={withBase("/components/block")}>blocks</a> to organize content into scannable sections.
