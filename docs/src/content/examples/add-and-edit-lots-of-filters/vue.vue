...
<template>
  <goa-button version="2" id="open-filters-btn" @_click="openDrawer">Filters</goa-button>
  <goa-drawer
    version="2"
    heading="Filters"
    position="right"
  ...
  >
    ...
    <div slot="actions">
      <goa-button-group alignment="start">
        <goa-button version="2" type="primary" size="compact" @_click="closeDrawer">Apply filters</goa-button>
