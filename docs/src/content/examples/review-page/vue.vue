...
<template>
  ...
  <goa-button-group alignment="start" mt="2xl">
    <goa-button version="2" type="primary" @_click="onConfirm">Confirm and continue</goa-button>
    <goa-button version="2" type="tertiary">Back to application overview</goa-button>
  </goa-button-group>
</template>
