<template>
  ...
  <form>
    <goa-form-item version="2" label="Provide details about your situation" helptext="Include specific details to help us answer your question quickly.">
      <goa-textarea version="2" name="program" maxcount="400" countby="character"></goa-textarea>
    </goa-form-item>
  </form>
  ...
  <goa-button-group alignment="start" mt="2xl">
    <goa-button version="2" type="primary" @_click="onContinue"> Continue </goa-button>
  </goa-button-group>
</template>

<script setup lang="ts">
function onContinue() {
  const textarea = document.getElementById("program-textarea") as any;
