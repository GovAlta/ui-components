...
<template>
  <goa-tabs version="2" initialtab="2">
    ...
    <goa-tab>
      <div slot="heading">
        Review pending<goa-badge version="2" type="important" content="4" icon="false"></goa-badge>
      </div>
      <goa-table version="2" width="100%">
        <table width="100%">
          <thead>
    ...
    <goa-tab>
      <div slot="heading">
        Complete<goa-badge version="2" type="information" content="338" icon="false"></goa-badge>
      </div>
      <goa-table version="2" width="100%">
        <table width="100%">
          <thead>
