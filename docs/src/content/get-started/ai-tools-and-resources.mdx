...
<goa-table width="100%" mb="m">
  <table width="100%">
    ...
    <tbody>
      ...
      <tr>
        <td><span style={{ display: "inline-flex", flexDirection: "column", alignItems: "flex-start", gap: "0.375rem" }}><a href="#md-files">MD files</a><goa-badge type="default" icon="false" emphasis="subtle" content="Coming soon"></goa-badge></span></td>
      ...
      <tr>
        <td><span style={{ display: "inline-flex", flexDirection: "column", alignItems: "flex-start", gap: "0.375rem" }}><a href="#figma-mcp">Figma MCP</a><goa-badge type="default" icon="false" emphasis="subtle" content="External"></goa-badge></span></td>
...
<goa-callout type="information" emphasis="low" heading="Use these tools together" mt="none" mb="2xl">
...
<div style={{ display: "flex", alignItems: "center", flexWrap: "wrap", gap: "var(--goa-space-xs)", marginTop: "var(--goa-space-2xl)", marginBottom: "var(--goa-space-m)" }}>
  ...
  <goa-badge type="default" icon="false" emphasis="subtle" content="Coming soon"></goa-badge>
</div>
...
<p>Built and maintained by Figma.</p>
