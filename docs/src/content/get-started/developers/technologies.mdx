...
<goa-text size="heading-xl" mt="none" mb="m">Technologies</goa-text>
<goa-text size="body-l" mt="none" mb="2xl">An overview of the technologies used in the Design System.</goa-text>

<goa-text as="h2" id="how-technologies-fit-together" size="heading-m">How the technologies fit together</goa-text>
<p>
  ...
  to use in those frameworks. Vue consumes the Web Components directly, with no wrapper layer needed.
</p>
  <p>
...
<img src={withBase(`/images/technologies.svg`)} alt="Diagram showing the technology layers: Svelte compiles to Web Components, which are wrapped by Angular and React" style={{ width: "100%", maxWidth: "700px", margin: "var(--goa-space-l) 0" }} />
<goa-text as="h2" id="web-components" size="heading-m">Web Components</goa-text>
<p>
...
<goa-text size="heading-xs">Benefits of using Web Components</goa-text>
<ul>
...
<goa-callout version="2" type="important" emphasis="low" mb="m">
  <goa-text size="body-m" mt="2xs" mb="none">Do not use Web Components directly unless there is a specific reason to do so. Using wrappers provides type checking and developer helpers that are not available when working with the core Web Components alone.</goa-text>
</goa-callout>
<goa-text as="h2" id="svelte" size="heading-m">Svelte</goa-text>
<p>
...
<goa-text size="heading-xs">Why Svelte</goa-text>
<p>We use Svelte to:</p>
<ul>
  <li>Build reusable Web Components</li>
  <li>Keep component logic, structure, and styling together</li>
  <li>Support integration with multiple front-end frameworks</li>
</ul>
<goa-text as="h2" id="angular" size="heading-m">Angular</goa-text>
...
<goa-text size="heading-xs">How Web Components and Angular work together</goa-text>
...
<goa-text as="h2" id="react" size="heading-m">React</goa-text>
...
<goa-text size="heading-xs">How Web Components and React work together</goa-text>
...
<goa-text as="h2" id="vue" size="heading-m">Vue</goa-text>

<goa-callout version="2" type="information" emphasis="low" mb="m">
  <goa-text size="body-m" mt="2xs" mb="none">Supported versions: 3</goa-text>
</goa-callout>
...
<goa-text size="heading-xs">How Web Components and Vue work together</goa-text>
<p>
  Vue applications use the core Web Components directly. Teams configure Vue to
  recognise <code>goa-*</code> tags as custom elements. This approach:
</p>
<ul>
