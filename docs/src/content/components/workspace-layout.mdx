...
The main navigation for the workspace, built with a <a href={withBase("/components/work-side-menu")}>work side menu</a>. It stays in place while the content scrolls. On narrow screens it hides and opens from the mobile hamburger menu.
