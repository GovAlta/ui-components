...
The following components are included for comparing focus treatments. Tab through each to inspect focus styles.
...
<goa-checkbox version="2" text="Checkbox label"></goa-checkbox>

### Radio Group

<goa-radio-group version="2" name="focus-compare">
