...
export function Feat2829Route() {
  ...
  return (
    <div
      style={{ display: "flex", flexDirection: "column", gap: "var(--goa-spacing-xl)" }}
    >
      <h1>Feature 2829: Modal with Scrolling Content</h1>

      <p>
        This feature demonstrates a modal with extensive content that requires scrolling
        on a 4K screen.
      </p>

      <GoabButton type="primary" onClick={openModal}>
        Open Modal (Dialog)
      </GoabButton>

      <GoabButton type="secondary" onClick={openAlertModal}>
        Open Modal (Alert Dialog)
      </GoabButton>

      <GoabModal
        open={isModalOpen}
        heading="Feature 2829 Modal"
        role="dialog"
        onClose={closeModal}
      >
        {/* Extensive content to fill 4K screen */}
        ...
        {/* Middle Input */}
        <GoabFormItem
          label="Middle Input Field"
          helpText="This input is in the middle of the modal content"
        >
          <GoabInput name="middleInput" placeholder="Enter text here" />
        </GoabFormItem>
        ...
        <GoabText as="p" size="body-m">
          ...
          consequences, or one who avoids a pain that produces no resultant pleasure? On
        ...
        {/* Bottom Input */}
        <GoabFormItem
          label="Bottom Input Field"
          helpText="This input is at the bottom of the modal content"
        >
          <GoabInput name="bottomInput" placeholder="Enter text here" />
        </GoabFormItem>

        {/* Actions slot for close button */}
        <div slot="actions">
      ...
      <GoabModal
        ...
        heading="Feature 2829 Alert Modal"
        role="alertdialog"
      ...
      >
        ...
        <GoabFormItem
          ...
          helpText="This input is in the middle of the modal content"
        >
          <GoabInput name="alertMiddleInput" placeholder="Enter text here" />
        </GoabFormItem>
        ...
        <GoabFormItem
          ...
          helpText="This input is at the bottom of the modal content"
        >
          <GoabInput name="alertBottomInput" placeholder="Enter text here" />
        </GoabFormItem>

        {/* Actions slot for close button */}
        <div slot="actions">
          <GoabButton type="secondary" onClick={closeAlertModal}>
            Close Modal
          </GoabButton>
        </div>
      </GoabModal>
