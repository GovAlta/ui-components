...
export function EverythingBRoute() {
  // hooks
  ...
  const [hasActionsSlot, setActionsSlot] = useState("y");
    ...
    <GoabOneColumnLayout>
      ...
      <section>
        <GoabPageBlock width="full">
          <goa-link leadingicon="arrow-back" mt="xl">
            <Link to="/">Back to main playground</Link>
          </goa-link>
        </GoabPageBlock>
      </section>
      ...
      <section slot="header">
        ...
        <GoabAppHeader url="#" heading="Find housing">
          <a href="#">sdsa</a>
        ...
        <GoabAppHeader url="#" heading="Pay your traffic ticket">
          ...
          <GoabTabs onChange={(detail) => onChange(detail.tab)}>
            ...
            >
              <GoabBlock gap="2xl" direction="column" mt="3xl">
                ...
                <GoabBlock direction="column">
                  ...
                  <GoabBlock>
                    ...
                    <GoabBadge
                      ...
                      iconType="star"
                    ></GoabBadge>
                    <GoabBadge type="emergency" content="Custom Emergency"></GoabBadge>
                    <GoabBadge type="important" content="Information"></GoabBadge>
                  </GoabBlock>
                </GoabBlock>
                  ...
                  <GoabGrid gap="xl" minChildWidth="400px">
                    ...
                    >
                      ...
                      <GoabButtonGroup alignment="start">
                        ...
                        <GoabButton type="tertiary">Back to task list</GoabButton>
                      </GoabButtonGroup>
                    </GoabContainer>
                  </GoabGrid>
                </GoabBlock>
                ...
                <GoabBlock gap="xl" mb="xl" direction="column">
                  <GoabFormItem label="Click to upload a file">
                    <GoabFileUploadInput
                      maxFileSize="100MB"
                      variant="button"
                      onSelectFile={() => {
                  ...
                  <GoabFormItem label="Drag and drop a file or click to upload a file">
                    <GoabFileUploadInput
                      maxFileSize="100MB"
                      onSelectFile={() => {
                        /** do nothing **/
                ...
                <GoabBlock gap="2xl" mb="xl" direction="column">
                  ...
                  >
                    <GoabInput value={value} name="item"></GoabInput>
                  </GoabFormItem>
                  ...
                  <GoabFormItem
                    label="Optional text input (default width)"
                    requirement="optional"
                  >
                    <GoabInput
                      name="name1"
                  ...
                  <GoabFormItem label="Text input with 2rem width and leading and trailing content">
                    <GoabInput
                      name="name1"
                      type="text"
                      value=""
                  ...
                  <GoabFormItem label="Text input with 10rem width">
                    <GoabInput
                      name="name1"
                      type="text"
                      value=""
                  ...
                  <GoabBlock gap="xl" direction="row">
                    <GoabFormItem label="First fields">
                      <GoabInput
                        name="name1"
                        value=""
                        width="20ch"
                    ...
                    <GoabFormItem label="Second field" helpText={"Helper text"}>
                      <GoabInput
                        name="name1"
                        value=""
                        width="20ch"
                ...
                <GoabBlock gap="2xl" mb="xl" direction="column"></GoabBlock>
                ...
                <GoabBlock gap="xl" mb="xl" direction="column">
                  ...
                  <GoabModal
                    heading="This is a modal with everything in the wrong place"
                    open={basicModal2Open}
                    role="alertdialog"
                    actions={
                      <GoabButtonGroup alignment="end">
                  ...
                  >
                    <p>
                      This is a lot of content that make the modal scroll. This is a lot
                      of content that make the modal scroll. This is a lot of content that
                      make the modal scroll. This is a lot of content that make the modal
                      scroll. This is a lot of content that make the modal scroll. This is
                      a lot of content that make the modal scroll. This is a lot of
                      content that make the modal scroll. This is a lot of content that
                      make the modal scroll. This is a lot of content that make the modal
                      scroll. This is a lot of content that make the modal scroll. This is
                      a lot of content that make the modal scroll. This is a lot of
                      content that make the modal scroll. This is a lot of content that
                      ...
                      make the modal scroll. This is a lot of content that make the modal
                      scroll. This is a lot of content that make the modal scroll. This is
                      a lot of content that make the modal scroll.
                    </p>
                    <GoabFormItem label="Basic">
                      <GoabInput
                        name="item"
                        ...
                        width="20ch"
                        onChange={function (
                          detail: GoabInputOnChangeDetail<string>,
                        ): void {
                  ...
                  >
                    <p>
                      ...
                      facilisis quam ac massa commodo fringilla. Sed gravida elit urna,
                      vel rhoncus velit ullamcorper vitae. Phasellus ullamcorper enim et
                      leo dignissim, sed dignissim mi varius.
                    </p>
                  </GoabModal>
                </GoabBlock>
                    ...
                    <div style={{ maxWidth: "256px" }}>
                      <GoabSideMenu>
                        ...
                        <GoabSideMenuGroup heading="Group heading" icon="person">
                          <a href="#">Foo</a>
                          <a href="#">
                            Bar ndjkasndnsa dsadsajd saj djsad jkas dka djk jks adjksa
                            djkas dkjas djk askjd asjkd sajkd akjsd asd ksa djkas dja ds
                          </a>
                        </GoabSideMenuGroup>
                      </GoabSideMenu>
                    </div>
                ...
                <GoabBlock direction="column" gap="s" mb="2xl">
                  <GoabButton
                    type="primary"
                    onClick={() => {
                      setSnackbarKey((prev) => prev + 1);
                      setSnackbarVisible("basic");
                    }}
                  >
                    Show basic (4s)
                  </GoabButton>
                  ...
                  <GoabButton
                    ...
                    onClick={() => {
                      setSnackbarKey((prev) => prev + 1);
                      setSnackbarVisible("basic-plus");
                    }}
                  >
                    Show basic with lots of content (7s)
                  </GoabButton>
                  ...
                  <GoabButton
                    ...
                    onClick={() => {
                      setSnackbarKey((prev) => prev + 1);
                      setSnackbarVisible("basic-plus-button");
                    }}
                  >
                    Show basic with lots of content and an action (10s)
                  </GoabButton>
                  ...
                  <GoabButton
                    ...
                    onClick={() => {
                      setSnackbarKey((prev) => prev + 1);
                      setSnackbarVisible("loading");
                    }}
                  >
                    Show loading (indefinite)
                  </GoabButton>

                  {/*
              {snackbarVisible === "basic" && (
                <GoabSnackbar
              ...
              {snackbarVisible === "basic-plus" && (
                <GoabSnackbar
                  ...
                  horizontalPosition="center"
                >
                  Lorem ipsum dolor sit amet consectetur. Donec odio mi cras scelerisque
                  libero purus. In facilisis tellus tristique orci.
                </GoabSnackbar>
              )}

              {snackbarVisible === "basic-plus-button" && (
                <GoabSnackbar
                  key={`snackbar-${snackbarKey}`}
                  type="basic"
                  visible={true}
                  ...
                  horizontalPosition="center"
                >
                  Informational message for the user that is a lot more content that wraps
                  to another line. Informational message for the user that is a lot more
                  content that wraps to another line.
                  <div slot="actions">
                    <GoabButton
                      type="tertiary"
                      size="compact"
            ...
            <GoabTab heading="Inputs">
              <GoabBlock gap="2xl" direction="column" mt="none" mb="4xl">
                ...
                <GoabFormItem label="Input type date">
                  <GoabInput
                ...
                <GoabFormItem
                  label="20ch Text input with no max width on form item"
                  helpText="Lorem ipsum dolor sit amet consectetur sollicitudin. Lorem ipsum dolor sit amet consectetur sollicitudin. Lorem ipsum dolor sit amet consectetur sollicitudin."
                >
                  <GoabInput
                    onChange={inputOnChange}
                    value={value}
                ...
                <GoabFormItem
                  label="20ch Text input with 65ch max width on form item"
                  maxWidth={"65ch"}
                  helpText="Lorem ipsum dolor sit amet consectetur sollicitudin. Lorem ipsum dolor sit amet consectetur sollicitudin. Lorem ipsum dolor sit amet consectetur sollicitudin."
                >
                  <GoabInput
                ...
                <GoabFormItem
                  label="100% Text input with no max width on form item"
                  helpText="Lorem ipsum dolor sit amet consectetur sollicitudin. Lorem ipsum dolor sit amet consectetur sollicitudin. Lorem ipsum dolor sit amet consectetur sollicitudin."
                >
                  <GoabInput
                    onChange={inputOnChange}
                ...
                <GoabFormItem
                  label="100% Text input with 65ch max width on form item"
                  maxWidth={"65ch"}
                  helpText="Lorem ipsum dolor sit amet consectetur sollicitudin. Lorem ipsum dolor sit amet consectetur sollicitudin. Lorem ipsum dolor sit amet consectetur sollicitudin."
                >
                  <GoabInput
                ...
                <GoabFormItem
                  label="85ch Text input with max width on form item because you can use a slot for goa-text in"
                  maxWidth="65ch"
                  helpText={
                    <>
                      <GoabText size="body-xs">
                        Lorem ipsum dolor sit amet consectetur sollicitudin. Lorem ipsum
                        dolor sit amet consectetur sollicitudin. Lorem ipsum dolor sit
                        amet consectetur sollicitudin.
                      </GoabText>
                    </>
                  }
                >
                ...
                <GoabFormItem
                  label="Text input with trailing icon button"
                  maxWidth={"65ch"}
                  helpText="Lorem ipsum dolor sit amet consectetur sollicitudin. Lorem ipsum dolor sit amet consectetur sollicitudin. Lorem ipsum dolor sit amet consectetur sollicitudin."
                >
                  <GoabInput
                ...
                <GoabFormItem
                  ...
                  helpText="Lorem ipsum dolor sit amet consectetur sollicitudin. Lorem ipsum dolor sit amet consectetur sollicitudin. Lorem ipsum dolor sit amet consectetur sollicitudin."
                >
                  <GoabDatePicker onChange={inputOnChange} name="item"></GoabDatePicker>
                </GoabFormItem>
                <GoabFormItem
                  label="Text input with trailing icon button"
                  maxWidth={"65ch"}
            ...
            <GoabTab heading="Tables">
              <GoabBlock gap="xl" mb="xl" direction="column">
                ...
                {/* Table Column Type Alignment Section - From TableExamples.tsx */}
                <style>{`
                  /* Proposed CSS Solution for GitHub Issue #3088 */
                  /* Note: goa-table already applies vertical-align: top to all td elements */
                  /* These classes set symmetric padding to achieve exact cell heights and center components */
                  /* Using higher specificity selector to override table defaults */

                  /* Normal variant (target: 48px cell height) */
                  /* Formula: padding = (48px - component_height) / 2 */
                  /* Must override table default: padding: 8px 16px 8px */
                  ...
                  /* Input cells (42px component height) */
                  ...
                  /* Button cells (32px component height) */
                ...
                <GoabTable width="100%">
                  <thead>
                    <tr>
                      <th>Select</th>
                      <th>ID</th>
                      <th>Name (Text Input)</th>
                      <th>Amount (Number)</th>
                      <th>Status (Badge)</th>
                      <th>Priority (Dropdown)</th>
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td className="goa-table-cell--badge">
                        <GoabBadge type="success" content="Active" icon={true} />
                      </td>
                      <td className="goa-table-cell--dropdown">
                        <GoabDropdown name="tom_priority1" value="High" width="140px">
                          <GoabDropdownItem value="High" label="High" />
                          <GoabDropdownItem value="Medium" label="Medium" />
                          <GoabDropdownItem value="Low" label="Low" />
                        </GoabDropdown>
                      </td>
                    ...
                    <tr>
                      ...
                      <td className="goa-table-cell--badge">
                        <GoabBadge type="information" content="Pending" icon={true} />
                      </td>
                      <td className="goa-table-cell--dropdown">
                        <GoabDropdown name="tom_priority2" value="Medium" width="140px">
                          <GoabDropdownItem value="High" label="High" />
                          <GoabDropdownItem value="Medium" label="Medium" />
                          <GoabDropdownItem value="Low" label="Low" />
                        </GoabDropdown>
                    ...
                    <tr>
                      ...
                      <td className="goa-table-cell--badge">
                        <GoabBadge type="emergency" content="Urgent" icon={true} />
                      </td>
                      <td className="goa-table-cell--dropdown">
                        <GoabDropdown name="tom_priority3" value="High" width="140px">
                          <GoabDropdownItem value="High" label="High" />
                          <GoabDropdownItem value="Medium" label="Medium" />
                          <GoabDropdownItem value="Low" label="Low" />
                        </GoabDropdown>
            ...
            <GoabTab heading="Spacer">
              <div style={{ backgroundColor: "grey", padding: "16px", margin: "0" }}>
                {" "}
                none (below)
              </div>
              <GoabSpacer vSpacing="none"></GoabSpacer>
              <div
                style={{
              ...
              <div style={{ backgroundColor: "#A7A7A7", padding: "16px", margin: "0" }}>
                2xs
              </div>
              ...
              <GoabBlock gap={"none"} mt={"4xl"}>
                <div
                  style={{ backgroundColor: "#A7A7A7", padding: "16px", margin: "0" }}
                ></div>
                <GoabSpacer hSpacing="none"></GoabSpacer>
                <div style={{ backgroundColor: "grey", padding: "16px", margin: "0" }}>
                  none (beside)
                </div>
              </GoabBlock>
              <GoabBlock gap={"none"}>
                <div
                  style={{ backgroundColor: "#A7A7A7", padding: "16px", margin: "0" }}
                ></div>
                <GoabSpacer hSpacing="3xs"></GoabSpacer>
                <div style={{ backgroundColor: "grey", padding: "16px", margin: "0" }}>
                  3xs
                </div>
              </GoabBlock>
              <GoabBlock gap={"none"}>
                <div
                  style={{ backgroundColor: "#A7A7A7", padding: "16px", margin: "0" }}
                ></div>
                <GoabSpacer hSpacing="2xs"></GoabSpacer>
                <div style={{ backgroundColor: "grey", padding: "16px", margin: "0" }}>
                  2xs
                </div>
              </GoabBlock>
              <GoabBlock gap={"none"}>
                <div
                  style={{ backgroundColor: "#A7A7A7", padding: "16px", margin: "0" }}
                ></div>
                <GoabSpacer hSpacing="xs"></GoabSpacer>
                <div style={{ backgroundColor: "grey", padding: "16px", margin: "0" }}>
                  xs
                </div>
              </GoabBlock>
              ...
              <GoabBlock gap={"none"}>
                <div
                  style={{ backgroundColor: "#A7A7A7", padding: "16px", margin: "0" }}
                ></div>
                <GoabSpacer hSpacing="m"></GoabSpacer>
                <div style={{ backgroundColor: "grey", padding: "16px", margin: "0" }}>
                  m
                </div>
              </GoabBlock>
              <GoabBlock gap={"none"}>
                <div
                  style={{ backgroundColor: "#A7A7A7", padding: "16px", margin: "0" }}
                ></div>
                <GoabSpacer hSpacing="l"></GoabSpacer>
                <div style={{ backgroundColor: "grey", padding: "16px", margin: "0" }}>
                  l
                </div>
              </GoabBlock>
              <GoabBlock gap={"none"}>
                <div
                  style={{ backgroundColor: "#A7A7A7", padding: "16px", margin: "0" }}
                ></div>
                <GoabSpacer hSpacing="xl"></GoabSpacer>
                <div style={{ backgroundColor: "grey", padding: "16px", margin: "0" }}>
                  xl
                </div>
              </GoabBlock>
              <GoabBlock gap={"none"}>
                <div
                  style={{ backgroundColor: "#A7A7A7", padding: "16px", margin: "0" }}
                ></div>
                <GoabSpacer hSpacing="2xl"></GoabSpacer>
                <div style={{ backgroundColor: "grey", padding: "16px", margin: "0" }}>
                  2xl
                </div>
              </GoabBlock>
              <GoabBlock gap={"none"}>
                <div
                  style={{ backgroundColor: "#A7A7A7", padding: "16px", margin: "0" }}
                ></div>
                <GoabSpacer hSpacing="3xl"></GoabSpacer>
                <div style={{ backgroundColor: "grey", padding: "16px", margin: "0" }}>
                  3xl
                </div>
              </GoabBlock>
              <GoabBlock gap={"none"}>
                <div
                  style={{ backgroundColor: "#A7A7A7", padding: "16px", margin: "0" }}
                ></div>
                <GoabSpacer hSpacing="4xl"></GoabSpacer>
                <div style={{ backgroundColor: "grey", padding: "16px", margin: "0" }}>
                  4xl
                </div>
              </GoabBlock>
              <GoabBlock gap={"none"} mb={"4xl"}>
                <div
                  style={{ backgroundColor: "#A7A7A7", padding: "16px", margin: "0" }}
                ></div>
