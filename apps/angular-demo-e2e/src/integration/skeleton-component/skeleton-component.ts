...
Then(/^cs I should be able to validate css properties of text skeleton$/, function () {
  // cy.get('goa-skeleton[type="text"]').find('div[class="skeleton text text-1"]').should("have.css", "width", "100%");
  ...
  cy.get('goa-skeleton[type="text"]').find(".skeleton.text.text-1").should("have.css", "animation", properties['animation']);
  cy.get('goa-skeleton[type="text"]').find(".skeleton.text.text-1").should("have.css", "margin", "10px 0px");
...
Then(/^cs I should be able to validate css properties of paragraph skeleton$/, function () {
  ...
  cy.get('goa-skeleton[type="paragraph"]').find(".skeleton.paragraph.paragraph-1").should("have.css", "background-color", hexToRgb(properties['color-gray-100']));
  cy.get('goa-skeleton[type="paragraph"]').find(".skeleton.paragraph.paragraph-1").should("have.css", "animation", properties['animation']);
  cy.get('goa-skeleton[type="paragraph"]').find(".skeleton.paragraph.paragraph-1").should("have.css", "margin", "10px 0px");
...
Then(/^cs I should be able to validate css properties of text-small skeleton$/, function () {
  ...
  cy.get('goa-skeleton[type="text-small"]').find(".skeleton.text-small.text-small-1").should("have.css", "background-color", hexToRgb(properties['color-gray-100']));
  cy.get('goa-skeleton[type="text-small"]').find(".skeleton.text-small.text-small-1").should("have.css", "animation", properties['animation']);
  cy.get('goa-skeleton[type="text-small"]').find(".skeleton.text-small.text-small-1").should("have.css", "margin", "10px 0px");
...
Then(/^cs I should be able to validate css properties of cards skeleton$/, function () {
  ...
  cy.get('goa-skeleton[type="card"]').find(".skeleton.image.image-1").should("have.css", "animation", properties['animation']);
  cy.get('goa-skeleton[type="card"]').find(".skeleton.image.image-1").should("have.css", "margin", "0px");
  ...
  cy.get('goa-skeleton[type="card"]').find(".skeleton.header.header-4").should("have.css", "border-radius", remToPx("0.3rem"));
});
...
Then(/^cs I should be able to validate css properties of avatar skeleton$/, function () {
  ...
  cy.get('goa-skeleton[type="avatar"]').find(".skeleton.avatar.avatar-1").should("have.css", "background-color", hexToRgb(properties['color-gray-100']));
  cy.get('goa-skeleton[type="avatar"]').find(".skeleton.avatar.avatar-1").should("have.css", "animation", properties['animation']);
  cy.get('goa-skeleton[type="avatar"]').find(".skeleton.avatar.avatar-1").should("have.css", "margin", "10px 0px");
  //2
...
Then(/^cs I should be able to validate css properties of header skeleton$/, function () {
  ...
  cy.get('goa-skeleton[type="header"]').find(".skeleton.header.header-1").should("have.css", "border-radius", remToPx(properties['border-radius']));
  ...
  cy.get('goa-skeleton[type="header"]').find(".skeleton.header.header-1").should("have.css", "animation", properties['animation']);
  // cy.get('goa-skeleton[type="header"]').find(".skeleton.header.header-1").should("have.css", "margin", "10px 0px");
  //2
...
Then(/^cs I should be able to validate css properties of thumbnails skeleton$/, function () {
  ...
  cy.get('goa-skeleton[type="thumbnail"]').find(".skeleton.thumbnail.thumbnail-1").should("have.css", "background-color", hexToRgb(properties['color-gray-100']));
  cy.get('goa-skeleton[type="thumbnail"]').find(".skeleton.thumbnail.thumbnail-1").should("have.css", "animation", properties['animation']);
  cy.get('goa-skeleton[type="thumbnail"]').find(".skeleton.thumbnail.thumbnail-1").should("have.css", "margin", "10px 0px");
  //2
  ...
  //4
  cy.get('goa-skeleton[type="thumbnail"]').find(".skeleton.thumbnail.thumbnail-4").should("have.css", "width", "120px");
