...
Then(
  /^cs I should be able to validate dropdown button css property$/,
  function () {
    cy.get('goa-input[id="colors-dropdown-input"]')
...
Then(
  /^cs I should be able to validate dropdown menu css property$/,
  function () {
    cy.get('goa-input[id="colors-dropdown-input"]')
