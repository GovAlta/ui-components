...
Then(/^cs I should be able to validate radio error button css property when unchecked$/, function () {
  cy.get('goa-radio-group[name="color1"]').find('label.goa-radio.goa-radio--error').find('div.goa-radio-icon').should("have.css", "border");
  cy.get('goa-radio-group[name="color1"]').find('label.goa-radio.goa-radio--error').find('div.goa-radio-icon').should("have.css", "border-radius", "50%");
  cy.get('goa-radio-group[name="color1"]').find('label.goa-radio.goa-radio--error').find('div.goa-radio-icon').should("have.css", "border").should("contain", hexToRgb(properties["goa-color-status-emergency"]));
  cy.get('goa-radio-group[name="color1"]').find('label.goa-radio.goa-radio--error').find('div.goa-radio-icon').should("have.css", "width", remToPx(properties["goa-radio-diameter"]));
  cy.get('goa-radio-group[name="color1"]').find('label.goa-radio.goa-radio--error').find('div.goa-radio-icon').should("have.css", "height", remToPx(properties["goa-radio-diameter"]));
  cy.get('goa-radio-group[name="color1"]').find('label.goa-radio.goa-radio--error').find('div.goa-radio-icon').should("have.css", "box-sizing", properties["box-sizing"]);
  cy.get('goa-radio-group[name="color1"]').find('label.goa-radio.goa-radio--error').find('div.goa-radio-icon').should("have.css", "color", hexToRgb(properties["goa-color-text"]));
  cy.get('goa-radio-group[name="color1"]').find('label.goa-radio.goa-radio--error').find('div.goa-radio-icon').should("have.css", "font-size", remToPx(properties["fs-base"]));
  cy.get('goa-radio-group[name="color1"]').find('label.goa-radio.goa-radio--error').find('div.goa-radio-icon').should("have.css", "font-family", properties["font-family"]);
});
