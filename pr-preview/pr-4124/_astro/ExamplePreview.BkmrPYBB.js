import{j as e}from"./jsx-runtime.u17CrQMm.js";import{r as d}from"./index.BAnu8Lhe.js";import{G as v}from"./tooltip.BGrZ7pMJ.js";import"./workspace-layout-scroll-state.CwoYdGbs.js";import{CodeSnippet as C}from"./CodeSnippet.BoJHV0Qw.js";import{p as j}from"./purify.es.DdwdxIb1.js";const N={CUSTOM_ELEMENT_HANDLING:{tagNameCheck:/^goa-/,attributeNameCheck:()=>!0}};function q({title:g,slug:w,code:r,figmaUrl:u,codeMaxHeight:y=200,fullWidth:b=!1,previewStyle:x,titleSize:_="small"}){const[c,f]=d.useState(!1),l=d.useRef(null),p=`example-${w}`;d.useEffect(()=>{if(l.current&&r.webComponents){const a=r.webComponents.match(/<script>([\s\S]*?)<\/script>/i),s=a?a[1]:null,m=r.webComponents.replace(/<goa-([a-z-]+)/g,(o,t)=>t==="microsite-header"?o:`<goa-${t} version="2"`).trim(),i=j.sanitize(m,N);if(l.current.innerHTML=i,s)try{const o=l.current,t=s.replace(/document\.getElementById\s*\(\s*["']([^"']+)["']\s*\)/g,(h,n)=>`__preview__.querySelector("#${n}")`).replace(/document\.querySelector\s*\(\s*["']([^"']+)["']\s*\)/g,(h,n)=>`__preview__.querySelector("${n}")`).replace(/document\.querySelectorAll\s*\(\s*["']([^"']+)["']\s*\)/g,(h,n)=>`__preview__.querySelectorAll("${n}")`);new Function("__preview__",t)(o)}catch(o){console.error("Error executing example script:",o)}}},[r.webComponents]);const k=async()=>{try{const a=`${window.location.origin}${window.location.pathname}#${p}`;await navigator.clipboard.writeText(a),f(!0),setTimeout(()=>f(!1),2e3)}catch(a){console.error("Failed to copy link:",a)}};return e.jsxs("div",{className:"example-preview",children:[e.jsxs("div",{className:"example-header",children:[_==="large"?e.jsx("h1",{id:p,className:"example-title example-title--large",children:g}):e.jsx("h3",{id:p,className:"example-title",children:g}),e.jsxs("div",{className:"example-actions",children:[e.jsx(v,{content:c?"Copied":"Copy link",children:e.jsx("button",{className:`copy-link-button ${c?"copied":""}`,onClick:k,"aria-label":"Copy link to this example",children:c?e.jsx("goa-icon",{type:"checkmark",size:"small"}):e.jsx("goa-icon",{type:"link",size:"small"})})}),u&&e.jsx(v,{content:"View Figma component",children:e.jsx("a",{href:u,target:"_blank",rel:"noopener noreferrer",className:"figma-link","aria-label":"View Figma component",children:e.jsx("goa-icon",{type:"logo-figma",size:"small"})})})]})]}),e.jsx("div",{className:"preview-area",children:e.jsx("div",{className:`preview-container${b?" full-width":""}`,ref:l,style:x?Object.fromEntries(x.split(";").filter(a=>a.trim()).map(a=>{const[s,...m]=a.split(":"),i=s.trim();return[i.startsWith("--")?i:i.replace(/-([a-z])/g,(o,t)=>t.toUpperCase()),m.join(":").trim()]})):void 0,children:!r.webComponents&&e.jsx("span",{className:"preview-placeholder",children:"Preview not available"})})}),e.jsx("div",{className:"code-area",children:e.jsx(C,{frameworkCode:{react:r.react,angular:r.angular?{ts:r.angular.component,template:r.angular.template}:void 0,webComponents:r.webComponents},maxHeight:y,showCopy:!0})}),e.jsx("style",{children:`
      ...
      `})]})}export{q as ExamplePreview,q as default};
