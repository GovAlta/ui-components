...
| `max` | Date | string | — | No | Maximum date value allowed. |
| `mb` | Spacing | — | No |  |
| `min` | Date | string | — | No | Minimum date value allowed. |
| `ml` | Spacing | — | No |  |
| `mr` | Spacing | — | No |  |
| `mt` | Spacing | — | No |  |
| `name` | string | — | No | Name of the date field. |
...
| `value` | Date | string | undefined | — | No | Value of the calendar date, as a Date object or an ISO date string (yyyy-mm-dd). |
| `width` | string | — | No | Sets the width of the date picker input. |
...
| `max` | Date | string | — | No | Sets the maximum date value allowed. |
| `mb` | Spacing | — | No | Sets the bottom margin spacing token. |
| `min` | Date | string | — | No | Sets the minimum date value allowed. |
...
| `name` | string | — | No | Sets the name of the date field. |
| `testId` | string | — | No | Sets the data-testid attribute for automated testing. |
| `type` | GoabDatePickerInputType | `calendar` | No | Sets the date picker type. 'calendar' shows a calendar popup, 'input' shows just a date input. |
| `value` | Date | string | null | undefined | — | No | Sets the value of the calendar date. |
| `width` | string | — | No | Sets the width of the date picker input. |
...
| `max` | string | — | No | Maximum date value allowed. |
| `mb` | Spacing | — | No | Bottom margin. |
| `min` | string | — | No | Minimum date value allowed. |
...
| `value` | string | — | No | Value of the calendar date. |
...
| `_change` | CustomEvent<{ name: string; value: Date | string | null; valueStr: string }> |  |
