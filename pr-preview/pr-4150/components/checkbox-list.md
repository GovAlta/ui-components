...
|------|------|---------|----------|-------------|
| `disabled` | boolean | — | No | Disables all checkboxes in the list. |
| `error` | boolean | — | No | Shows an error state on all checkboxes in the list. |
| `maxWidth` | string | — | No | Sets the maximum width of the checkbox list container. |
| `mb` | Spacing | — | No |  |
| `ml` | Spacing | — | No |  |
| `mr` | Spacing | — | No |  |
| `mt` | Spacing | — | No |  |
| `name` | string | — | Yes | The name for the checkbox list group. Used as group identifier in change events. |
...
| `name` | string | — | No | The name for the checkbox list group. Used as group identifier in change events. |
