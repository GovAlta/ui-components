...
| `width` | string | — | No | Sets a custom width for the button (e.g., "200px" or "100%"). |
...
| `actionArg` | string | — | No | Single argument value passed with the action in click events. |
| `actionArgs` | Record<string, unknown> | — | No | Multiple argument values passed with the action in click events. |
| `disabled` | boolean | — | No | Sets the disabled state. When true, prevents user interaction and applies disabled styling. |
| `leadingIcon` | GoabIconType | — | No | Sets the icon displayed before the button text. |
...
| `leadingicon` | GoabIconType | — | No | Icon displayed before the button text. |
| `mb` | Spacing | — | No | Sets the bottom margin using design system spacing tokens. |
| `ml` | Spacing | — | No | Sets the left margin using design system spacing tokens. |
| `mr` | Spacing | — | No | Sets the right margin using design system spacing tokens. |
| `mt` | Spacing | — | No | Sets the top margin using design system spacing tokens. |
