...
|------|------|---------|----------|-------------|
| `heading` | string | ReactNode | — | No | Sets the heading text or custom heading content. |
| `open` | boolean | — | No | Controls the open/closed state of the push drawer. |
...
| Prop | Type | Default | Required | Description |
|------|------|---------|----------|-------------|
| `heading` | string | TemplateRef<any> | — | No | Sets the heading text or template for the push drawer. |
| `open` | boolean | — | No | Sets the open state of the push drawer. |
| `testId` | string | — | No | Sets a data-testid attribute for automated testing. |
| `width` | string | — | No | Sets the width of the push drawer panel. |
