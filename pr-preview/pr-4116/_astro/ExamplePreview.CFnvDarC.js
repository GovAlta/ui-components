import{j as e}from"./jsx-runtime.D_zvdyIk.js";import{r as d}from"./index.DeO6U63H.js";import{G as f}from"./tooltip.CcOCTibQ.js";import"./workspace-layout-scroll-state.Ch1khooy.js";import{CodeSnippet as C}from"./CodeSnippet.BxRtr5Vm.js";import{g as j}from"./tab-hash.Badzwm3T.js";import{p as N}from"./purify.es.D6gMnemd.js";import"./button.DwTFmpvn.js";import"./framework-preference.DlzkYYed.js";/* empty css                             */const $={CUSTOM_ELEMENT_HANDLING:{tagNameCheck:/^goa-/,attributeNameCheck:()=>!0}};function R({title:g,slug:w,code:a,figmaUrl:h,codeMaxHeight:y=200,fullWidth:b=!1,previewStyle:u,titleSize:_="small"}){const[m,v]=d.useState(!1),n=d.useRef(null),p=`example-${w}`;d.useEffect(()=>{if(n.current&&a.webComponents){const r=a.webComponents.match(/<script>([\s\S]*?)<\/script>/i),t=r?r[1]:null,l=a.webComponents.replace(/<goa-([a-z-]+)/g,(o,i)=>i==="microsite-header"?o:`<goa-${i} version="2"`).trim(),s=N.sanitize(l,$);if(n.current.innerHTML=s,t)try{const o=n.current,i=t.replace(/document\.getElementById\s*\(\s*["']([^"']+)["']\s*\)/g,(x,c)=>`__preview__.querySelector("#${c}")`).replace(/document\.querySelector\s*\(\s*["']([^"']+)["']\s*\)/g,(x,c)=>`__preview__.querySelector("${c}")`).replace(/document\.querySelectorAll\s*\(\s*["']([^"']+)["']\s*\)/g,(x,c)=>`__preview__.querySelectorAll("${c}")`);new Function("__preview__",i)(o)}catch(o){console.error("Error executing example script:",o)}}},[a.webComponents]);const k=async()=>{try{const r=j(n.current),t=r?`${r}#${p}`:p,l=`${window.location.origin}${window.location.pathname}#${t}`;await navigator.clipboard.writeText(l),v(!0),setTimeout(()=>v(!1),2e3)}catch(r){console.error("Failed to copy link:",r)}};return e.jsxs("div",{className:"example-preview",children:[e.jsxs("div",{className:"example-header",children:[_==="large"?e.jsx("h1",{id:p,className:"example-title example-title--large",children:g}):e.jsx("h3",{id:p,className:"example-title",children:g}),e.jsxs("div",{className:"example-actions",children:[e.jsx(f,{content:m?"Copied":"Copy link",children:e.jsx("button",{className:`copy-link-button ${m?"copied":""}`,onClick:k,"aria-label":"Copy link to this example",children:m?e.jsx("goa-icon",{type:"checkmark",size:"small"}):e.jsx("goa-icon",{type:"link",size:"small"})})}),h&&e.jsx(f,{content:"View Figma component",children:e.jsx("a",{href:h,target:"_blank",rel:"noopener noreferrer",className:"figma-link","aria-label":"View Figma component",children:e.jsx("goa-icon",{type:"logo-figma",size:"small"})})})]})]}),e.jsx("div",{className:"preview-area",children:e.jsx("div",{className:`preview-container${b?" full-width":""}`,ref:n,style:u?Object.fromEntries(u.split(";").filter(r=>r.trim()).map(r=>{const[t,...l]=r.split(":"),s=t.trim();return[s.startsWith("--")?s:s.replace(/-([a-z])/g,(o,i)=>i.toUpperCase()),l.join(":").trim()]})):void 0,children:!a.webComponents&&e.jsx("span",{className:"preview-placeholder",children:"Preview not available"})})}),e.jsx("div",{className:"code-area",children:e.jsx(C,{frameworkCode:{react:a.react,angular:a.angular?{ts:a.angular.component,template:a.angular.template}:void 0,webComponents:a.webComponents},maxHeight:y,showCopy:!0})}),e.jsx("style",{children:`
        .example-preview {
        }
