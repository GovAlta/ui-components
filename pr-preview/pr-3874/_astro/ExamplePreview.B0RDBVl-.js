import{j as e}from"./jsx-runtime.D_zvdyIk.js";import{r as d}from"./index.DeO6U63H.js";import{G as f}from"./tooltip.Dj_n7hLI.js";import"./theme-context.DBIa_puq.js";import{p as C,C as j}from"./purify.es.D6sLTCS-.js";import"./button.B-V87hrX.js";import"./framework-preference.DlzkYYed.js";/* empty css                        */const N={CUSTOM_ELEMENT_HANDLING:{tagNameCheck:/^goa-/,attributeNameCheck:()=>!0}};function M({title:g,slug:w,code:r,figmaUrl:v,codeMaxHeight:y=200,fullWidth:b=!1,previewStyle:u,titleSize:_="small"}){const[c,x]=d.useState(!1),l=d.useRef(null),p=`example-${w}`;d.useEffect(()=>{if(l.current&&r.webComponents){const a=r.webComponents.match(/<script>([\s\S]*?)<\/script>/i),s=a?a[1]:null,m=r.webComponents.replace(/<goa-([a-z-]+)/g,(o,t)=>t==="microsite-header"?o:`<goa-${t} version="2"`).trim(),i=C.sanitize(m,N);if(l.current.innerHTML=i,s)try{const o=l.current,t=s.replace(/document\.getElementById\s*\(\s*["']([^"']+)["']\s*\)/g,(h,n)=>`__preview__.querySelector("#${n}")`).replace(/document\.querySelector\s*\(\s*["']([^"']+)["']\s*\)/g,(h,n)=>`__preview__.querySelector("${n}")`).replace(/document\.querySelectorAll\s*\(\s*["']([^"']+)["']\s*\)/g,(h,n)=>`__preview__.querySelectorAll("${n}")`);new Function("__preview__",t)(o)}catch(o){console.error("Error executing example script:",o)}}},[r.webComponents]);const k=async()=>{try{const a=`${window.location.origin}${window.location.pathname}#${p}`;await navigator.clipboard.writeText(a),x(!0),setTimeout(()=>x(!1),2e3)}catch(a){console.error("Failed to copy link:",a)}};return e.jsxs("div",{className:"example-preview",children:[e.jsxs("div",{className:"example-header",children:[_==="large"?e.jsx("h1",{id:p,className:"example-title example-title--large",children:g}):e.jsx("h3",{id:p,className:"example-title",children:g}),e.jsxs("div",{className:"example-actions",children:[e.jsx(f,{content:c?"Copied":"Copy link",children:e.jsx("button",{className:`copy-link-button ${c?"copied":""}`,onClick:k,"aria-label":"Copy link to this example",children:c?e.jsx("goa-icon",{version:"2",type:"checkmark",size:"small"}):e.jsx("goa-icon",{version:"2",type:"link",size:"small"})})}),v&&e.jsx(f,{content:"View Figma component",children:e.jsx("a",{href:v,target:"_blank",rel:"noopener noreferrer",className:"figma-link","aria-label":"View Figma component",children:e.jsx("goa-icon",{version:"2",type:"logo-figma",size:"small"})})})]})]}),e.jsx("div",{className:"preview-area",children:e.jsx("div",{className:`preview-container${b?" full-width":""}`,ref:l,style:u?Object.fromEntries(u.split(";").filter(a=>a.trim()).map(a=>{const[s,...m]=a.split(":"),i=s.trim();return[i.startsWith("--")?i:i.replace(/-([a-z])/g,(o,t)=>t.toUpperCase()),m.join(":").trim()]})):void 0,children:!r.webComponents&&e.jsx("span",{className:"preview-placeholder",children:"Preview not available"})})}),e.jsx("div",{className:"code-area",children:e.jsx(j,{frameworkCode:{react:r.react,angular:r.angular?{ts:r.angular.component,template:r.angular.template}:void 0,webComponents:r.webComponents},maxHeight:y,showCopy:!0})}),e.jsx("style",{children:`
        .example-preview {
        }
