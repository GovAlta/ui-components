...
import { continueTo, relay } from "../app/public-form-utils";
import {
  dateValidator,
  FieldsetState,
  requiredValidator,
...
type Data = {
  name: { firstname: { name: string; value: string } };
};
...
export class ApplicationComponent {
  ...
  updateState(e: Event) {
    ...
    console.log("State change!!", this._state.form["name"]); //.name.firstname.value);
  }
